 ...
 * Description:
 */
public class CopyGCHBulk {

    private static final String queryClause = "{\n" +
            "  \"size\": 1000\n" +
            "}";

    private static final String endpointForQuery = "/flume-2017-03-gch-content-news/_search";
    private static final String endpointForScrollQuery = "/_search/scroll";
    private static final String INDEX_TAG = "{ \"index\" : { \"_index\" : \"flume-2017-03-gch-content-news\", \"_type\" : \"flumetype\"} }";
    ...
    public static void main(String[] args) {
        ...
        RestClient restClientGch = RestClient.builder(
                new HttpHost("gch1", 19200, "http"))
                .setRequestConfigCallback(new RestClientBuilder.RequestConfigCallback() {
                    public RequestConfig.Builder customizeRequestConfig(RequestConfig.Builder requestConfigBuilder) {
                        return requestConfigBuilder.setConnectTimeout(5000)
                                .setSocketTimeout(30000);
...
//                    System.out.println("clause:" + strUpdate.toString());
                    Response updateResponse = restClientGch.performRequest("POST", "/_bulk",
