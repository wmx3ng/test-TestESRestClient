 ...
 * Description:
 */
public class CopyrightCopyWithBulk {
    ...
    private static final String queryClause = "{\n" +
            ...
            "            {\n" +
            "              \"term\": {\n" +
            "                \"sn_dataSource\": \"software_copyright_assign\"\n" +
            "              }\n" +
            "            }\n" +
            "          ],\n" +
            "          \"must_not\": [\n" +
    ...
    private static final String INDEX_TAG = "{ \"index\" : { \"_index\" : \"flume-copyright-change\", \"_type\" : \"flumetype\"} }";
