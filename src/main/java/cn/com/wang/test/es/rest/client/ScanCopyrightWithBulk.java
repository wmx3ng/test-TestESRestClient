 ...
 * Description:
 */
public class ScanCopyrightWithBulk {
    ...
    private static final String endpointForQuery = "/flume-copyright-other/_search";
...
//                        final Map<String, Object> doc = resolveSourceOfSoftwareCopyright(source);
                        final Map<String, Object> doc = resolveSourceOfCopyrightContract(source);
    ...
    public static Map<String, Object> resolveSourceOfCopyrightContract(Map<String, Object> source) {
        if (source == null || source.isEmpty()) {
            return Collections.emptyMap();
        }
        Map<String, Object> doc = new HashMap<String, Object>();
        doc.put("sn_dataSource", "copyright_contract");
        return doc;
    }
}
